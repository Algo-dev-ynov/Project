...
from API.script.picture import Picture
...
path_picture = os.path.join(BASE_DIR,"API", "pictures")
...
api = Api(api_key,url_api,path_output,path_state,page_file,page_size,time_sleep) # Objet
# api.extract_data() # Extrait les données depuis l'API
# print(set(api.extract_types())) # Affiche la liste des types de POI
